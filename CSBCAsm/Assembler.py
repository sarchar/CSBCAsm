...
class BuildInstructionAction(BuilderAction):
    ...
    def _format_operands(self, values):
        return {
            Opcodes.OpcodeDatabase.AddressingMode.BRKCOP                           : lambda v: "0x{:02}".format(v[0]),
            ...
            Opcodes.OpcodeDatabase.AddressingMode.STACK_RELATIVE                   : lambda v: "0x{:02}, S".format(v[0]),
            Opcodes.OpcodeDatabase.AddressingMode.STACK_RELATIVE_INDIRECT_INDEXED_Y: lambda v: "(0x{:02}, S), Y".format(v[0]),
            ...
            Opcodes.OpcodeDatabase.AddressingMode.BLOCK_MOVE                       : lambda v: "0x{:02}, 0x{:02}".format(v[1], v[0]),
            Opcodes.OpcodeDatabase.AddressingMode.DIRECT                           : lambda v: "0x{:02}".format(v[0]),
            Opcodes.OpcodeDatabase.AddressingMode.DIRECT_INDEXED_X                 : lambda v: "0x{:02}, X".format(v[0]),
            Opcodes.OpcodeDatabase.AddressingMode.DIRECT_INDEXED_Y                 : lambda v: "0x{:02}, Y".format(v[0]),
            Opcodes.OpcodeDatabase.AddressingMode.DIRECT_INDEXED_X_INDIRECT        : lambda v: "(0x{:02}, X)".format(v[0]),
            Opcodes.OpcodeDatabase.AddressingMode.DIRECT_INDIRECT_INDEXED_Y        : lambda v: "(0x{:02}), Y".format(v[0]),
            Opcodes.OpcodeDatabase.AddressingMode.DIRECT_INDIRECT                  : lambda v: "(0x{:02})".format(v[0]),
            Opcodes.OpcodeDatabase.AddressingMode.DIRECT_INDIRECT_LONG             : lambda v: "[0x{:02}]".format(v[0]),
            Opcodes.OpcodeDatabase.AddressingMode.DIRECT_INDIRECT_LONG_INDEXED_Y   : lambda v: "[0x{:02}], Y".format(v[0]),
