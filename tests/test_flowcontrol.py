...
'''
    code = assemble_string(program_string)
    print(code)
    assert code['code']['code'][0][1] == bytes([0xA9, 0x01, 0xC9, 0x01, 0xD0, 0x03, 0xEA, 0x80, 0x0C,
                                                            0xC9, 0x02, 0xD0, 0x03, 0xE8, 0x80, 0x05,
                                                            0xC9, 0x03, 0xD0, 0x01, 0xC8,
                                                0xA9, 0x01, 0x44, 0xC9, 0x01, 0x44, 0xD0, 0x03, 0xEA, 0x80, 0x0E,
                                                                  0xC9, 0x02, 0x44, 0xD0, 0x03, 0xE8, 0x80, 0x06,
...
'''
    code = assemble_string(program_string)
    assert code['code']['code'][0][1] == bytes([0xA2, 0x01, 0xE0, 0x01, 0xD0, 0x03, 0xEA, 0x80, 0x0C,
                                                            0xE0, 0x02, 0xD0, 0x03, 0xE8, 0x80, 0x05,
                                                            0xE0, 0x03, 0xD0, 0x01, 0xC8,
                                                0xA2, 0x01, 0x44, 0xE0, 0x01, 0x44, 0xD0, 0x03, 0xEA, 0x80, 0x0E,
                                                                  0xE0, 0x02, 0x44, 0xD0, 0x03, 0xE8, 0x80, 0x06,
...
'''
    code = assemble_string(program_string)
    assert code['code']['code'][0][1] == bytes([0xA0, 0x01, 0xC0, 0x01, 0xD0, 0x03, 0xEA, 0x80, 0x0C,
                                                            0xC0, 0x02, 0xD0, 0x03, 0xE8, 0x80, 0x05,
                                                            0xC0, 0x03, 0xD0, 0x01, 0xC8,
                                                0xA0, 0x01, 0x44, 0xC0, 0x01, 0x44, 0xD0, 0x03, 0xEA, 0x80, 0x0E,
                                                                  0xC0, 0x02, 0x44, 0xD0, 0x03, 0xE8, 0x80, 0x06,
